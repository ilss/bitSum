// Chapter15OneBitImproved (c) Charles Petzold, 2024 

let Chapter15OneBitImproved = 
{
    name: "Chapter15OneBitImproved",
    transform: {x: -20, y: 55, scale: 1, rotate: 0},
    propagationDelay: 100,
    wireCurveRadius: 10,
    components:
    [
        { name: "fuller", type: "External", file: "Chapter15OneBitFullerMod", scale: 0.65, y: 26 },
