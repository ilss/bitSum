// Chapter08OrLogicRelays.json.js (c) Charles Petzold, 2024

var Chapter08OrLogicRelays = {
    name: "Chapter08OrLogicRelays",
    ...
    [
        ...
        { name: "jt1", type: "Joint", relative: { x: { name:"outNode"}, y: { name: "common.relay1", io: "out1"}}},
        { name: "jt2", type: "Joint", relative: { x: { name:"outNode"}, y: { name: "common.relay2", io: "out1"}}},
    ...
    [
        ...
        { name: "wireNode1", points: [ { name:"common.relay1", io: "out1"}, { name: "jt1"}, { name: "outNode"}]},
        { name: "wireNode2", points: [ { name:"common.relay2", io: "out1"}, { name: "jt2"}, { name: "outNode"}]},
